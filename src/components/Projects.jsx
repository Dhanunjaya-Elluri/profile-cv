...
import { SiScikitlearn, SiPytorch } from 'react-icons/si';
  ...
  const projects = [
    {
      ...
      description: "Narwhals is an open-source Python library that provides a compatibility layer between dataframe libraries like Pandas, PyArrow, Polars, Modin, etc.",
    ...
    },
    {
      ...
      icon: <img src={littleBookOfMLMetricsLogo} alt="The Little Book of ML Metrics" className="project-icon" />,
      description: "NannyML's The Little Book of ML Metrics is an open-source book that provides a comprehensive guide to machine learning metrics.",
    ...
    <div className="projects-container">
      <div className="projects-header">
        ...
        <p className="projects-intro">
          I enjoy making things. Here are a selection of projects that I have contributed or worked on over the years.
        </p>
      </div>
